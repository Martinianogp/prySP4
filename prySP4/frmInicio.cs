...
namespace prySP4
{
    public partial class frmInicio : Form
    {
        ...
        {
            switch (cmbGrafico.SelectedItem.ToString())
            {
        ...
        private void frmInicio_Load(object sender, EventArgs e)
        {
            ...
            cmbGrafico.Items.Add("Gráfico de columna");
            cmbGrafico.Items.Add("Gráfico de línea");
            cmbGrafico.Items.Add("Gráfico de barra");
            cmbGrafico.Items.Add("Gráfico circular");
